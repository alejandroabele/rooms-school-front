    ...
    return (
        <>
            ...
            <Box sx={{ padding: 4 }}>
                ...
                <Typography variant="h6" align="left">The frontend of this project is created with Vite, React, MUI and Typescript. It can be used as a reference to create a role-based login, manage cruds and pages within a project.</Typography>
                ...
                <br />
                <Link href="https://github.com/alejandroabele/rooms-school-api" target="_blank" >
                    <Typography variant='overline' align="left">
                        Gitlab Backend
                    </Typography>
                </Link>
